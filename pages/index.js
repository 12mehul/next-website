          ...
          <div>
            {products?.map((item, index) => {
              return (
                <div
                  key={index}
                  className={`flex box-border h-[67px] w-[517px] my-4 rounded-md cursor-pointer
            ${
              selectedItem === item
                ...
                >
                  <div className="w-12 h-14 py-2 my-auto ml-2 bg-white border rounded border-[#9c9898] ">
